const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/default-DvKKeSfK.js","assets/ssrBoot-UP-tJ6n9.js","assets/index--VYKYRCV.js","assets/VContainer-X80SIXPb.js","assets/VContainer-86XHr9wO.css","assets/index-Br4CDULP.css","assets/VOverlay-BuFSuReX.js","assets/forwardRefs-DWGaNmQL.js","assets/VOverlay-CJZCRGWG.css","assets/VList-Y65rEoUh.js","assets/VList-i-22bMcD.css","assets/default-BeyRP98d.css","assets/index-B0Kj3aI0.js","assets/VCard-B_9hsAGU.js","assets/VCard-Ckq9XVQu.css","assets/collection-qzucglpW.js","assets/cards-BLhZq7EU.js","assets/cards-CgkIFNCO.css","assets/VLabel-vZe_xWWC.js","assets/VLabel-CJ7y27R9.css","assets/route-block-B_A1xBdJ.js","assets/collection-Bufc1RW9.css","assets/matches-Drgld_S3.js","assets/matches-BlK8uFkX.css","assets/settings-BzdK7egx.js","assets/settings-BIH_AWWP.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gD(t,e={}){return Ai(t,"GET","/v2/passwordPolicy",Gf(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ni(t,e){return rD(t,"POST","/v1/accounts:signInWithIdp",Gf(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function SD(t,e,n=!1){const{auth:r}=t;if(Yt(r.app))return Promise.reject(gs(r));const s="reauthenticate";try{const i=await jo(t,NT(r,s,e,t),n);pe(i.idToken,r,"internal-error");const o=zf(i.idToken);pe(o,r,"internal-error");const{sub:a}=o;return pe(t.uid===a,r,"user-mismatch"),hi._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Bn(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $T{constructor(e,n,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:s,tenantId:i,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return KD;case"linkViaPopup":case"linkViaRedirect":return zD;case"reauthViaPopup":case"reauthViaRedirect":return GD;default:Bn(this.auth,"internal-error")}}resolve(e){cr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){cr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const UO=new Map,BO={activated:!1,tokenObservers:[]};function An(t){return UO.get(t)||Object.assign({},BO)}const zg={RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:16*60*1e3};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dh=new ta("@firebase/app-check");function Qg(t,e){return sT()?GO(t,e).catch(n=>{Dh.warn(`Failed to write token to IndexedDB. Error: ${n}`)}):Promise.resolve()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Jt(c1,u1,"app");const qT=Symbol("firebaseApp");function KT(t){return Tc()&&Ze(qT,null)||uT(t)}const h1=typeof window<"u",ja=new WeakMap;function f1(t,e){if(!ja.has(t)){const n=uc(!0);ja.set(t,n);const{unmount:r}=e;e.unmount=()=>{r.call(e),n.stop(),ja.delete(t)}}return ja.get(t)}const GT=new WeakMap;function GU(t){return GT.get(KT(t))}const Ha=new WeakMap;function zT(t){const e=KT(t);if(!Ha.has(e)){let n;const s=[new Promise(i=>{n=i}),i=>{Ha.set(e,i),n(i.value)}];Ha.set(e,s)}return Ha.get(e)}function d1(t){const e=zT(t);return Array.isArray(e)?e[0]:Promise.resolve(e.value)}function p1(t,e){kD(e,n=>{const r=zT();t.value=n,Array.isArray(r)&&r[1](t)})}var Zg={};const e_="@firebase/database",t_="1.0.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
