const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/default-DRL4S5pl.js","assets/ssrBoot-jqeKK55L.js","assets/index-CWvfA3Wk.js","assets/VContainer-CpVKZnI-.js","assets/VContainer-86XHr9wO.css","assets/index-Br4CDULP.css","assets/VOverlay-DzRGIpmX.js","assets/forwardRefs-DWGaNmQL.js","assets/VOverlay-CJZCRGWG.css","assets/VList-D-5OesZz.js","assets/VList-i-22bMcD.css","assets/default-BeyRP98d.css","assets/index-DY9PjJd6.js","assets/VCard-BIx-3W94.js","assets/VCard-Ckq9XVQu.css","assets/collection-38a4NOXj.js","assets/cards-Ba__tctF.js","assets/cards-CgkIFNCO.css","assets/VLabel-BEkeHTaA.js","assets/VLabel-CJ7y27R9.css","assets/route-block-B_A1xBdJ.js","assets/collection-Bufc1RW9.css","assets/matches-DNBwTSPZ.js","assets/matches-BlK8uFkX.css","assets/settings--tUDXlUL.js","assets/settings-BIH_AWWP.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _D(t,e={}){return Ai(t,"GET","/v2/passwordPolicy",zf(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ni(t,e){return sD(t,"POST","/v1/accounts:signInWithIdp",zf(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function PD(t,e,n=!1){const{auth:r}=t;if(Yt(r.app))return Promise.reject(gs(r));const s="reauthenticate";try{const i=await jo(t,NT(r,s,e,t),n);pe(i.idToken,r,"internal-error");const o=Gf(i.idToken);pe(o,r,"internal-error");const{sub:a}=o;return pe(t.uid===a,r,"user-mismatch"),hi._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Bn(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $T{constructor(e,n,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:s,tenantId:i,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return zD;case"linkViaPopup":case"linkViaRedirect":return QD;case"reauthViaPopup":case"reauthViaRedirect":return GD;default:Bn(this.auth,"internal-error")}}resolve(e){cr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){cr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BO=new Map,$O={activated:!1,tokenObservers:[]};function An(t){return BO.get(t)||Object.assign({},$O)}const Gg={RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:16*60*1e3};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Jt(u1,h1,"app");const qT=Symbol("firebaseApp");function KT(t){return Tc()&&Ze(qT,null)||uT(t)}const f1=typeof window<"u",ja=new WeakMap;function d1(t,e){if(!ja.has(t)){const n=uc(!0);ja.set(t,n);const{unmount:r}=e;e.unmount=()=>{r.call(e),n.stop(),ja.delete(t)}}return ja.get(t)}const zT=new WeakMap;function GU(t){return zT.get(KT(t))}const Ha=new WeakMap;function GT(t){const e=KT(t);if(!Ha.has(e)){let n;const s=[new Promise(i=>{n=i}),i=>{Ha.set(e,i),n(i.value)}];Ha.set(e,s)}return Ha.get(e)}function p1(t){const e=GT(t);return Array.isArray(e)?e[0]:Promise.resolve(e.value)}function m1(t,e){ND(e,n=>{const r=GT();t.value=n,Array.isArray(r)&&r[1](t)})}var Zg={};const e_="@firebase/database",t_="1.0.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qx(t){let e="";const n=t.split("/");for(let r=0;r<n.length;r++)if(n[r].length>0){let s=n[r];try{s=decodeURIComponent(s.replace(/\+/g," "))}catch{}e+="/"+s}return e}function Kx(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const r=n.split("=");r.length===2?e[decodeURIComponent(r[0])]=decodeURIComponent(r[1]):Zt(`Invalid query segment '${n}' in query '${t}'`)}return e}const O_=function(t,e){const n=zx(t),r=n.namespace;n.domain==="firebase.com"&&Es(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!r||r==="undefined")&&n.domain!=="localhost"&&Es("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||w1();const s=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new O1(n.host,n.secure,r,s,e,"",r!==n.subdomain),path:new ze(n.pathString)}},zx=function(t){let e="",n="",r="",s="",i="",o=!0,a="https",c=443;if(typeof t=="string"){let u=t.indexOf("//");u>=0&&(a=t.substring(0,u-1),t=t.substring(u+2));let h=t.indexOf("/");h===-1&&(h=t.length);let f=t.indexOf("?");f===-1&&(f=t.length),e=t.substring(0,Math.min(h,f)),h<f&&(s=qx(t.substring(h,f)));const m=Kx(t.substring(Math.min(t.length,f)));u=e.indexOf(":"),u>=0?(o=a==="https"||a==="wss",c=parseInt(e.substring(u+1),10)):u=e.length;const g=e.slice(0,u);if(g.toLowerCase()==="localhost")n="localhost";else if(g.split(".").length<=2)n=g;else{const E=e.indexOf(".");r=e.substring(0,E).toLowerCase(),n=e.substring(E+1),i=r}"ns"in m&&(i=m.ns)}return{host:e,port:c,domain:n,subdomain:r,secure:o,scheme:a,pathString:s,namespace:i}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
